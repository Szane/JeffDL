...
def container():
    ...
    ocr_str_conNum = ocr_str[0]
    ocr_str_weight = ocr_str[1]
    ...
    return json.dumps({"containerNum": res_conNum, "msg_conNum": msg_conNum, "success_conNum": success_conNum, "weight_kg": res_weight_kg, "weight_lb": res_weight_lb, "msg_weight": msg_weight, "success_weight": success_weight})
