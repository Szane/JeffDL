...
# Transform the predicted bounding boxes for the 300x480 image to the original image dimensions.
                ...
                self.xmax = min(int(box[4] * self.orig_images[0].shape[1] / self.img_width) + 90, self.orig_images[0].shape[1])
                self.ymax = min(int(box[5] * self.orig_images[0].shape[0] / self.img_height) + 20, self.orig_images[0].shape[0])
